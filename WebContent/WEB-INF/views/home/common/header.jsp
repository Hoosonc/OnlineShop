...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">Hooson在线商城</a></b>
						<c:if test="${account == null }">
						[<a href="../home/login">登录</a>][<a href="../home/register">注册</a>]
						</c:if>
						<c:if test="${account != null }">
						[${account.name }][<a href="../home/logout">退出登陆</a>]
						</c:if>
					</p>
				</div>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/OnlineShop"><img src="../resources/home/images/logo.png" alt="ShopCZ" /></a><span>商城</span></h1></div>
